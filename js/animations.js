...
(function(){
    /* ============================================
       ✏️  হিরো সেকশনের পার্টিকেল নাম পরিবর্তন করতে
       শুধু নিচের কোটেশনের মধ্যের নাম বদলান:
    ============================================ */
    const PARTICLE_NAME = 'ISRAT JAHAN ISRU';
    ...
    function buildParticles(){
        ...
        octx.textAlign = 'left';
        octx.fillText(PARTICLE_NAME, 4, canvas.height/2);
